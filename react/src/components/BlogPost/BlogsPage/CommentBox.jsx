...
export const CommentBox = ({
  ...
  return (
    <>
      <div className="z-51 h-screen w-screen bg-transparent fixed top-0 left-0 backdrop-blur-md">
        <div className="fixed md:w-1/3 z-51 w-full overflow-auto right-0 h-full border border-gray-400 flex flex-col justify-between gap-2 items-center bg-gray-100 dark:bg-gray-700">
