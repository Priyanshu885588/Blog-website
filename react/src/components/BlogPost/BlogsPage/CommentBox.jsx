...
export const CommentBox = ({ handleCommentBox }) => {
  return (
    <>
      ...
      <div className="fixed bottom-2 md:w-1/3 z-51 right-2 w-9/12 overflow-auto h-screen-90 rounded-lg border border-gray-400 flex flex-col justify-between gap-2 items-center bg-gray-100 dark:bg-gray-700">
        ...
        <div className="w-full overflow-auto h-full flex items-start">
