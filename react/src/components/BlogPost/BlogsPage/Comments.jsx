...
export const Comments = ({commentArray}) => {
  ...
  return (
    <div className="w-16 bg-slate-100 rounded-r-xl h-12 shadow-md flex gap-2 justify-center dark:bg-gray-900 items-center ">
      <button
        type="button"
      ...
      <p className="text-black dark:text-white text-base">{commentArray.length}</p>
      {commentBox && <CommentBox handleCommentBox={handleCommentBox} />}
    </div>
  );
};
