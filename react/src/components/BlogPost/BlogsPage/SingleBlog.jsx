...
export const SingleBlog = ({ singlePost, handleSingleblog }) => {
  ...
  return (
    ...
    >
      <p
        className=" text-gray-300 dark:text-gray-200 cursor-pointer hover:text-gray-400 hover:dark:text-white text-4xl "
      ...
      <div
        ...
        className="w-11/12 md:w-3/4 p-6 bg-gray-100 border box-shadow border-gray-200 rounded-2xl dark:bg-transparent dark:border-gray-700 flex flex-col pb-1 items-center justify-between "
      >
      ...
      <p
        className={`loto text-xs font-extralight text-gray-100 dark:text-gray-100 italic cursor-pointer`}
        onClick={readmore}
      >
        Read More
      </p>
      ...
      >
        <p
          id="publishDate"
          className="text-xs font-extralight text-gray-100 dark:text-gray-100 italic pt-1 text-center"
        >
